...
# BEGINNING OF SCRIPT
$SystemName = Get-ComputerName
Log-Message "Check Nessus Authentication Readiness Logfile for $SystemName"
Log-Message "===============================================================\n"
Log-Message ""
...
if ($isadmin) { 
	...
	Log-Message "Account is an administrator."
}
else { 
	Write-Host -ForegroundColor Red "FAIL" 
	Log-Message "Account is NOT an administrator."
}
...
if ($make_changes)
{
	...
	Log-Message "---- Restoring settings ----"
		...
		if ($set_network_sharing)
		{
			...
			Log-Message "Reverted network adapter binding."
		}
